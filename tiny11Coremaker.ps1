# Enable debugging
#Set-PSDebug -Trace 1
Function Invoke-TinyCoreMaker {
    [CmdletBinding()]
    param (
        [Parameter(Mandatory = $false)]
        [string]
        $ISOPath = 'C:\Users\testing\Downloads\Windows11_InsiderPreview_Client_x64_en-us_27718.iso'
    )
    ...
    $driveLetter = Mount-DiskImage -ImagePath $ISOPath -PassThru | Get-Volume | Where-Object { $_.DriveLetter } | Select-Object -ExpandProperty DriveLetter
